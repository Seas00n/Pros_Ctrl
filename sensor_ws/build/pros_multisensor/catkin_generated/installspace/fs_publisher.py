...
if __name__ == "__main__":
    ...
    msg_pub = Foot_Plate()
    rospy.init_node("fs_publisher")
    pub = rospy.Publisher("fs_pub", Foot_Plate, queue_size=10)
    rate = rospy.Rate(20) 
    time.sleep(2)
    ...
    while not rospy.is_shutdown():
        ...
        msg_pub.F_area1 = force_msg[0]
        msg_pub.x_area1 = force_msg[1]
        msg_pub.y_area1 = force_msg[2]
        msg_pub.F_area2 = force_msg[3]
        msg_pub.x_area2 = force_msg[4]
        msg_pub.y_area2 = force_msg[5]
        msg_pub.F_area3 = force_msg[6]
        msg_pub.x_area3 = force_msg[7]
        msg_pub.y_area3 = force_msg[8]
        pub.publish(msg_pub)

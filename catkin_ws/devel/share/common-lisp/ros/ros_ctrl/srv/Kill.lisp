...
(cl:defmethod cl:initialize-instance :after ((m <Kill-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Kill-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_ctrl-srv:<Kill-request> is deprecated: use ros_ctrl-srv:Kill-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Kill-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_ctrl-srv:name-val is deprecated.  Use ros_ctrl-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <Kill-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Kill-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_ctrl-srv:<Kill-response> is deprecated: use ros_ctrl-srv:Kill-response instead.")))
